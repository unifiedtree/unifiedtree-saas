...
| Fiscal year | Done (w1e, decision D2) | One source: the company record (`org.companies.fiscal_year_start`). HR Configuration reads and writes it for the selected company; default April (Indian financial year). V143_14 carried over any month an admin had picked on HR Configuration. The headcount workbook's "this fiscal year" counts read it. |
