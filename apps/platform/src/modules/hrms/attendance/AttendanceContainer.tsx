...
export function AttendanceContainer() {
  ...
  }, [team.data, teamToday.data, trend.data, sources.data, sources.isLoading, monthSources.data, monthSources.isLoading, holidays.data, summary.data, lateMarks.data, face.data, review.data,
