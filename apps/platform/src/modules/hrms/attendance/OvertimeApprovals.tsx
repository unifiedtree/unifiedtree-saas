...
// Approved overtime is approval-only (no payroll posting yet), hence the
// "Recorded, not paid" line in the header rather than any amount.
const STATUS_LABEL:Record<string,string>={PENDING:'Pending approval',APPROVED:'Approved',REJECTED:'Rejected'}
