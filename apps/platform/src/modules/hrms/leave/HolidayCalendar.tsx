        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-white border border-border-default rounded-xl px-3 py-2 text-sm text-text-primary focus:outline-none focus:border-[#059669] transition-colors"
            />
          </div>
          <div>
            ...
            <input
              ...
              className="w-full bg-white border border-border-default rounded-xl px-3 py-2 text-sm text-text-primary placeholder-text-tertiary focus:outline-none focus:border-[#059669] transition-colors"
            />
          </div>
          <div>
          ...
          <>
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="bg-white border border-border-default rounded-lg px-2.5 py-1.5 text-sm text-text-primary focus:outline-none focus:border-[#059669] transition-colors"
              >
