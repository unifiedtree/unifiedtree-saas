...
export const AcceptInvite: React.FC = () => {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-bg-base p-4">
      <div className="absolute -top-48 -right-48 w-96 h-96 bg-[#059669]/15 rounded-full blur-[120px] pointer-events-none" />
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-slate-50 py-3 pl-10 pr-10 text-sm text-slate-900 outline-none focus:border-[#059669] focus:ring-4 focus:ring-[#059669]/30"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 bg-slate-50 py-3 pl-10 pr-4 text-sm text-slate-900 outline-none focus:border-[#059669] focus:ring-4 focus:ring-[#059669]/30"
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-2 w-full rounded-xl bg-[#059669] hover:bg-[#047857] py-4 text-sm font-bold text-white transition-all disabled:opacity-60"
              >
