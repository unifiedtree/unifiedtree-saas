...
try {
  ...
  check('letters: templates page on the kit', (await o.page.getByRole('heading', { name: 'Letter templates', level: 1 }).count()) === 1)
  ...
  check('letters: generated letters list without UUID fragments', (await o.page.getByRole('heading', { name: 'Generated letters' }).count()) === 1 && !/[0-9a-f]{8}…/.test(genText))
  ...
  check('letters: distributions page on the kit', (await o.page.getByRole('heading', { name: 'Letter distributions' }).count()) === 1)
